...
const mentalMathQuestionNumber =
  document.getElementById(
    "mental-math-question-number"
  );

const mentalMathCorrectCount =
  document.getElementById(
    "mental-math-correct-count"
  );
...
const mentalMathNextButton =
  document.getElementById(
    "mental-math-next-button"
  );

const mentalMathStartButton =
  document.getElementById(
    "mental-math-start-button"
  );
...
let mentalMathGameRunning =
  false;

let mentalMathQuestionCount =
  0;

let mentalMathCorrect =
  0;

let mentalMathScoreValue =
  0;

let mentalMathCurrentAnswer =
  null;

let mentalMathAnswered =
  false;
...
mentalMathStartButton.addEventListener(
  "click",
  function () {
...
mentalMathSubmitButton.addEventListener(
  "click",
  function () {
...
mentalMathNextButton.addEventListener(
  "click",
  function () {
...
mentalMathAnswer.addEventListener(
  "keydown",
  function (event) {
...
function startMentalMathGame() {
  ...
  mentalMathStartButton.textContent =
    "다시 시작";


  mentalMathSubmitButton.disabled =
    false;


  mentalMathNextButton.disabled =
    true;


  mentalMathAnswer.disabled =
    false;
...
function generateMentalMathQuestion() {
  ...
  mentalMathQuestion.textContent =
    problem.question;
